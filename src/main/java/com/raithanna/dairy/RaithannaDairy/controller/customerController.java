...
public class customerController {
    ...
    public ResponseEntity<?> getCustValues(@RequestParam Map<String, String> body) {
        ...
        respBody.putIfAbsent("custAddr1",Customer.getCustAddr1());
        respBody.putIfAbsent("custAddr2",Customer.getCustAddr2());
        respBody.putIfAbsent("custAddr3",Customer.getCustAddr3());
        respBody.putIfAbsent("custPostCode",Customer.getCustPostCode());
        respBody.putIfAbsent("custGst",Customer.getCustGst());
    ...
    public ResponseEntity<?> customerEdit(@RequestParam Map<String, String> body) {
        ...
        Customer.setCustAddr1(body.get("custAddr1"));
        Customer.setCustAddr2(body.get("custAddr2"));
        Customer.setCustAddr3(body.get("custAddr3"));
        Customer.setCustPostCode(body.get("custPostCode"));
        Customer.setCustGst(body.get("custGst"));
